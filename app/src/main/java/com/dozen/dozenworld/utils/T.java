...
public class T {
    ...
    private static void showToast(@StringRes int resId, int duration) {
        showToast(T.getContext().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
        showToast(String.format(T.getContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void showToast(CharSequence text, int duration) {
        ...
        if (sToast == null) {
            sToast = Toast.makeText(T.getContext(), text, duration);
        } else {
            sToast.setText(text);
