...
public class HelloView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float xc=paddingLeft+contentWidth/2;
        float yc=paddingLeft+contentHeight/2;
        ...
        Path path=new Path();
//        path.addCircle(x+300,y+200,200,Path.Direction.CW);
        path.addArc(xc-210,yc-210,xc+210,yc+210,0,720);

        float c= (float) (Math.PI*105*2);

        canvas.drawTextOnPath(mExampleString,path,c,0,mTextPaint);
//        canvas.drawPath(path,mTextPaint);

        canvas.drawArc(xc-100,yc-100,xc+100,yc+100,-135,270,true,mTextPaint);
